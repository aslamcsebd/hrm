   ...
   <div class="main-panel">
      ...
      <div class="container"><br>
         ...
         <div class="container">
			...
			<?php
			   ...
			   if (isset($_POST['addEmployee'])) {	
					...
					// Profile picture
						...
						if ($photo!=null) {
							$fullFileName= $location . $employee_id . str_replace($without_extension, '_'.$full_name, basename($photo));		
						}else{
							$fullFileName='';
						}	
						...
						$sql3="SELECT * FROM employee where employee_id='$employee_id'";
						$result3=mysqli_query($hrm,$sql3);
						$rowcount2 = mysqli_num_rows($result3);
						if ($rowcount2){
							$_SESSION['employee_id_exit']=true;
						}else{
							move_uploaded_file($_FILES["Profile_Picture"]["tmp_name"],$fullFileName);

							$sql4 ="insert into employee values (null, '$employee_id','$full_name','$father_name','$mother_name','$dob','$gender','$contact','$email','$blood_group','$education','$present_address','$permanent_address','$password','$job_type','$fullFileName')";
			...
			<?php if(isset($_SESSION['employee_id_exit'])) { ?>
           	<?php 
               echo '<script type="text/javascript">
                        alert("This employee id [ '.$employee_id.' ] already exists.\nUse another employee id.");
                     </script>';
            ?> 
			<?php } ?>
							          	...
							          	<div class="register-form">
							          		<fieldset class="scheduler-border animated zoomIn wow">
								            	...
								            	<form action="" method="POST" enctype="multipart/form-data">
									             	<?php $employee_id=rand(1000,10000); ?>  
									              	<div class="row">  
										               <div class="col-md-4 col-xs-12">
										                  <div class="form-group" align="center">
										                  	<label for="inputEmail3" class="col-3 col-form-label">Employee Id</label>
										                  </div> 
										               </div>  
										               <div class="col-md-8 col-xs-12">
										                  <div class="form-group">
										                    <input type="text" class="form-control" name="<?php echo "employee_id" ; ?>" placeholder=" employee id" value="<?= $employee_id; ?>">
										                  </div> 
										               </div>  
									              	</div>  
									              	...
									              	<div class="row">  
										               ...
										               <div class="col-md-8 col-xs-12">
										                  <div class="form-group" align="center" tyle="border: 1px solid #fff; padding: 8px;">
										                  	<div class="gender" >
									              	...
									              	<div class="row">  
										               ...
										               <div class="col-md-8 col-xs-12">
										                  <div class="form-group"  align="center" style="border: 1px solid #fff; padding: 8px;">
										                  	<div class="gender">
																  	...
																  	<label class="btn btn-secondary">
																    	<input type="radio" name="blood_group" value="N/A" autocomplete="off" required> N/A
																  	</label>
																  	</div>
										                  </div> 
										               </div>  
									              	...
									              	<div class="row">
										               ...
										               <div class="col-md-8 col-xs-12">	
										                  <div class="form-group" align="center" style="border: 1px solid #fff; padding: 10px;">		
										                    	<select class="custom-select mr-sm-2" name="job_type" value="O+" style="background-color: #1abc9c; font-size: 17px;" required>
										            ...
										            <div class="row">  
									              	...
									              	<div class="row">
									                  	...
									                  	<div class="form-group">
									                  		<a href="Employee_Information.php" class="btn btn-success btn-block btn-fill">Back</a>
										                  </div>
										               </div>
									                	<div class="col-md-6 col-xs-12">
									                  	<div class="form-group">
									                    		<input type="submit" name="addEmployee" value="Add Employee" class="btn btn-primary btn-fill btn-block" tabindex="7" style="color: #fff;">
									                  	</div>
									                	</div>								                	
										            </div>									         
										         </form>
