                                    ...
                                    <fieldset class="scheduler-border animated zoomIn wow">
                                       ...
                                       <form method="POST">
                                          ...
                                          <div class="form-group row" align="center">
                                             ...
                                             <div class="col-md-8">
                                                <textarea type="text" class="form-control" name="about" placeholder="About holiday" tyle="text-align: left;">
                                                   <?= $row['about']; ?>
                                                </textarea>
                                             </div> 
                                          </div> 
                                          ...
                                          <div class="form-group row">
                                             <div class="col-md-offset-4 col-md-8" style="background: transparent; border: none; text-align: left;">
                                                <button type="submit" name="updateHoliday" class="btn btn-info btn-fill tn-block">Update Now</button>
                                             </div>
                                          </div>    
                                       </form>
                                    </fieldset>
