...
<div class="wrapper">
   ...
   <div class="main-panel">
      ...
      <div class="container"><br>
         <div class="container">
            <a href="leaveApplicationConfirm.php" class="btn btn-success btn-fill">Back</a>
                                          ...
                                          <?php if (isset($_SESSION['adminLogin'])) { ?>
                                             <div class="row">
                                                <div class="col-md-offset-2 col-md-2 col-xs-12">
                                                   <div class="form-group">
                                                     <button type="submit" name="approve" class="btn btn-success btn-fill tn-block" onclick="return confirm('Are you sure?')" style="color: #fff;">Approve Request</button>
                                                   </div> 
                                                </div>  
                                                <div class="col-md-2 col-xs-12">
                                                   <div class="form-group">
                                                       <button type="submit" name="reject" class="btn btn-danger btn-fill tn-block" onclick="return confirm('Are you sure?')" style="color: #fff;">Reject Request</button>          
                                                   </div>
                                                </div>                                             
                                             </div> 
                                          <?php } ?>                                 
